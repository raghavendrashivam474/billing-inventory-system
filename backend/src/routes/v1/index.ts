...
import storageLocationRoutes  from '../../modules/storage-location/storage-location.routes';
...
v1Router.use('/storage-locations',  storageLocationRoutes);
